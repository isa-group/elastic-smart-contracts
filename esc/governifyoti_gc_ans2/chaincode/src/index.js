...
class analytics_chaincode extends Contract {
    ...
    */
     async queryData3(ctx, responseData) {
        ...
        return this.queryWithQueryString3(ctx, queryString);
    ...
    * @async
    */
    async queryDataCalculation3(ctx, dataId) {
    ...
    * @async
    */
    async createDataCalculation3(ctx) {
    ...
    */
    async updateData3(ctx, params) {

        let parameters = JSON.parse(params.toString())
        let s = await this.queryData3(ctx, parseInt(parameters.dataNumber));
     ...
     async analysis3(ctx, params) {
        ...
        if(frmDates.length > 0){
            ...
            for(let j=1; j<=numData; j++){
                let dataResponse = await this.queryData3(ctx, j);
        ...
        let s = await this.queryDataCalculation3(ctx, 1);
    ...
    */
     async evaluateHistory3(ctx, timeData, calculateTime, maxCalculateTime, minCalculateTime) {
    ...
    * @param {number} minCalculateTime - Minimum calculation time allowed.
    */
    async evaluateFrequency3(ctx, frequency, calculateTime, maxCalculateTime, minCalculateTime) {
    ...
    */
    async queryWithQueryString3(ctx, queryString) {
