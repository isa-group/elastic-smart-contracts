...
let config = {
  ...
  resultsPath: "./esc/governifyoti_gc_ans4/results",
  identityName: "admin",
  channelName: "escchannel",
  chaincodeName: "governifyoti_gc_ans4",
  ...
  updateDataContract: "updateData5",
  evaluateWindowTimeContract: "evaluateHistory5",
  evaluateHarvestFrequencyContract: "evaluateFrequency5",
  queryAnalysisHolderContract: "queryDataCalculation5",
  analysisHolderId: 2,
  analysisContract: "analysis5",
  dataStorageContract: "createData5",
  calculationStorageContract: "createDataCalculation5",
