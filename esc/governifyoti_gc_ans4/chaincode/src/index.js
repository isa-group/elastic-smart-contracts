...
class analytics_chaincode extends Contract {
    ...
    */
     async queryData5(ctx, responseData) {
        ...
        return this.queryWithQueryString5(ctx, queryString);
    ...
    * @async
    */
    async queryDataCalculation5(ctx, dataId) {
    ...
    * @async
    */
    async createDataCalculation5(ctx) {
    ...
    */
    async updateData5(ctx, params) {

        let parameters = JSON.parse(params.toString())
        let s = await this.queryData5(ctx, parseInt(parameters.dataNumber));
     ...
     async analysis5(ctx, params) {
        ...
        if(frmDates.length > 0){
            ...
            for(let j=1; j<=numData; j++){
                let dataResponse = await this.queryData5(ctx, j);
        ...
        let s = await this.queryDataCalculation5(ctx, 1);
    ...
    */
     async evaluateHistory5(ctx, timeData, calculateTime, maxCalculateTime, minCalculateTime) {
    ...
    * @param {number} minCalculateTime - Minimum calculation time allowed.
    */
    async evaluateFrequency5(ctx, frequency, calculateTime, maxCalculateTime, minCalculateTime) {
    ...
    */
    async queryWithQueryString5(ctx, queryString) {
