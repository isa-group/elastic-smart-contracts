...
class analytics_chaincode2 extends Contract {
    ...
    */
     async queryData2(ctx, responseData) {
    ...
    * @async
    */
    async queryDataCalculation2(ctx, dataId) {
    ...
    * @async
    */
    async createDataCalculation2(ctx) {
    ...
    */
    async updateData2(ctx, params) {
        ...
        let s = await this.queryData2(ctx, parseInt(parameters.dataNumber));
     ...
     async analysis2(ctx, params) {
        ...
        if(frmDates.length > 0){
            ...
            for(let j=1; j<=numData; j++){
                let dataResponse = await this.queryData2(ctx, j);
        ...
        let s = await this.queryDataCalculation2(ctx, 1);
...
module.exports = analytics_chaincode2;
