...
let config = {
  ...
  resultsPath: "./experiments_results/96/governifyoti_gc_ans1/",
  identityName: "admin",
  channelName: "escchannel",
  chaincodeName: "governifyoti_gc_ans1",
  ...
  updateDataContract: "updateData1",
  evaluateWindowTimeContract: "evaluateHistory1",
  evaluateHarvestFrequencyContract: "evaluateFrequency1",
  queryAnalysisHolderContract: "queryDataCalculation1",
  analysisHolderId: 1,
  analysisContract: "analysis1",
  dataStorageContract: "createData1",
  calculationStorageContract: "createDataCalculation1",
