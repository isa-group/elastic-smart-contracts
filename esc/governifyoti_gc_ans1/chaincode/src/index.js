...
class analytics_chaincode extends Contract {
    ...
    */
     async queryData1(ctx, responseData) {
        ...
        return this.queryWithQueryString1(ctx, queryString);
    ...
    * @async
    */
    async queryDataCalculation1(ctx, dataId) {
    ...
    * @async
    */
    async createDataCalculation1(ctx) {
    ...
    */
    async updateData1(ctx, params) {

        let parameters = JSON.parse(params.toString())
        let s = await this.queryData1(ctx, parseInt(parameters.dataNumber));
     ...
     async analysis1(ctx, params) {
        ...
        if(frmDates.length > 0){
            ...
            for(let j=1; j<=numData; j++){
                let dataResponse = await this.queryData1(ctx, j);
        ...
        let s = await this.queryDataCalculation1(ctx, 1);
    ...
    */
     async evaluateHistory1(ctx, timeData, calculateTime, maxCalculateTime, minCalculateTime) {
    ...
    * @param {number} minCalculateTime - Minimum calculation time allowed.
    */
    async evaluateFrequency1(ctx, frequency, calculateTime, maxCalculateTime, minCalculateTime) {
    ...
    */
    async queryWithQueryString1(ctx, queryString) {
