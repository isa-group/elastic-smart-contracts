...
class analytics_chaincode extends Contract {
    ...
    */
     async queryData4(ctx, responseData) {
        ...
        return this.queryWithQueryString4(ctx, queryString);
    ...
    * @async
    */
    async queryDataCalculation4(ctx, dataId) {
    ...
    * @async
    */
    async createDataCalculation4(ctx) {
    ...
    */
    async updateData4(ctx, params) {

        let parameters = JSON.parse(params.toString())
        let s = await this.queryData4(ctx, parseInt(parameters.dataNumber));
     ...
     async analysis4(ctx, params) {
        ...
        if(frmDates.length > 0){
            ...
            for(let j=1; j<=numData; j++){
                let dataResponse = await this.queryData4(ctx, j);
        ...
        let s = await this.queryDataCalculation4(ctx, 1);
    ...
    */
     async evaluateHistory4(ctx, timeData, calculateTime, maxCalculateTime, minCalculateTime) {
    ...
    * @param {number} minCalculateTime - Minimum calculation time allowed.
    */
    async evaluateFrequency4(ctx, frequency, calculateTime, maxCalculateTime, minCalculateTime) {
    ...
    */
    async queryWithQueryString4(ctx, queryString) {
