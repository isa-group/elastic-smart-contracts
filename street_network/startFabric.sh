...
./network.sh deployCCStreet -l ${CC_SRC_LANGUAGE}
popd
...
Next, use the Street_network applications to interact with the deployed Street_network contract.
The Street_network applications are available in multiple programming languages.
