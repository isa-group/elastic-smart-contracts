    ...
    try {
        ...
        const listener = await contract.addContractListener((event) => {
            ...
            if (event.type === 'analysis'){
                ...
                console.log(`Analysis event detected, waiting ${frequency} seconds to launch transaction`);
                ...
                setTimeout(() => {
                    ...
                    if(count == numberSensors){
                        ...
                        analysis(event.timeData, JSON.stringify(calculationDates), numberSensors, event.frequency);
                        calculationDates = [];
                        count = 0;
                    }                  
